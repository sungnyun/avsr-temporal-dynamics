...
class OverrideConfig(FairseqDataclass):
    ...
    tokenizer_bpe_model: Optional[str] = field(default=None, metadata={'help': 'path to test tokenizer'})
    w2v_path: Optional[str] = field(default=None, metadata={'help': 'path to original w2v_path'})
...
def _main(cfg, output_file):
    ...
    if cfg.override.w2v_path is not None:
        arg_overrides = {'w2v_path': cfg.override.w2v_path}
    else:
        arg_overrides = None
    ...
    task.cfg.noise_gaussian = cfg.override.noise_gaussian
